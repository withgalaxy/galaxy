...
func TestNetlifyAdapter_Name(t *testing.T) {
	adapter := New()
	if adapter.Name() != "netlify" {
		t.Errorf("expected name 'netlify', got '%s'", adapter.Name())
	}
}

func TestNetlifyAdapter_RejectsNonStatic(t *testing.T) {
	tmpDir := t.TempDir()
...
func TestNetlifyAdapter_Build(t *testing.T) {
	tmpDir := t.TempDir()
...
func TestNetlifyAdapter_RedirectsFormat(t *testing.T) {
	tmpDir := t.TempDir()
...
func TestNetlifyAdapter_HeadersFormat(t *testing.T) {
	tmpDir := t.TempDir()
